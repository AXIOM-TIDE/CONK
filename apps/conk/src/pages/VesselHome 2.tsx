  ...
  return (
    <div className="shell">
      ...
      <div style={{
        ...
        {/* Back */}
        <BackButton onClick={onBack} label="Harbor"/>
        ...
        <div
          ...
          {noFuel ? (
            <>
              ...
              <span style={{fontFamily:'var(--font-mono)',fontSize:'10px',fontWeight:600,color:'var(--burn)',letterSpacing:'0.04em'}}>
                dry · tap to charge
              </span>
            </>
          ) : (
            <>
              ...
              {fuelStatus !== 'stable' && (
                <span style={{
                  ...
                  color:fuelColor,letterSpacing:'0.06em',textTransform:'uppercase',
                  opacity:0.8,
                }}>
                  {fuelStatus}
                </span>
              ...
              <button
                ...
                style={{
                  ...
                  background:drawing?'var(--teal)':'var(--surface3)',
                  border:`1px solid ${drawing?'var(--teal)':'var(--border)'}`,
                  position:'relative',cursor:'pointer',transition:'all 0.2s',
                  flexShrink:0,padding:0,
                  boxShadow:drawing?'0 0 6px rgba(0,184,230,0.4)':'none',
                }}>
                <div style={{
                  width:'12px',height:'12px',
                  background:drawing?'var(--bg)':'var(--text-dim)',
                  borderRadius:'50%',position:'absolute',
                  top:'1px',left:drawing?'14px':'1px',
                  transition:'all 0.2s',
                }}/>
              </button>
              <span style={{
                fontFamily:'var(--font-mono)',fontSize:'8px',
                color:drawing?'var(--teal)':'var(--text-off)',
              ...
              <span style={{fontFamily:'var(--font-mono)',fontSize:'8px',color:autoBurn?'var(--burn)':'var(--text-off)',letterSpacing:'0.05em',whiteSpace:'nowrap'}}>
      ...
      {noFuel && tab !== 'drift' && (
        <div style={{
          ...
          <div style={{
            ...
            <button onClick={() => setShowDrawFuel(true)}
    ...
    <div style={{flex:1,overflowY:'auto',padding:'16px',scrollbarWidth:'thin',scrollbarColor:'var(--border2) transparent'}}>
      ...
      {stored.length === 0 ? (
        ...
        <div style={{display:'flex',flexDirection:'column',gap:'8px'}}>
          {stored.map(c => (
            <div key={c.id} style={{padding:'12px',background:'var(--surface)',border:'1px solid var(--border)',borderRadius:'var(--radius-lg)'}}>
