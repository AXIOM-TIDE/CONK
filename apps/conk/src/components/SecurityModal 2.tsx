    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{padding:'20px'}}>
          ...
          {/* Error */}
          {error && (
            <div style={{padding:'8px 10px', background:'var(--burn-dim)', border:'1px solid var(--burn-line)', borderRadius:'var(--radius)', fontFamily:'var(--font-mono)', fontSize:'10px', color:'var(--burn)', marginBottom:'12px', letterSpacing:'0.04em'}}>
