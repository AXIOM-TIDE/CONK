...
export const PACKAGES = {
  // v0.7.0-staging: points to v14 test package (fresh publish, NOT the production upgrade)
  // DO NOT use in production until founder approves DEPLOY-v14-PROD.sh
  CONK:  '0x214302d985fac734bd93a8ae74abeb51e010ad42e52864dc87f9af43ac3d5c9d', // v14-test — expiry-as-visibility staging (2026-06-06)
